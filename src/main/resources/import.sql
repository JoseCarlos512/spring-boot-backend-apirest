...
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('andres','$2a$10$oLb3PsUcrwEvAx057U6ER.fCZXOLMaiVnl6ueROTu..PfHquKW.Nq',1, 'Andres', 'Guzman','profesor@bolsadeideas.com');
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$IQzjCGig7Zg/kf3gNrxcX.3N65XHole8fk8TzocaQCGfr9myf6Cmy',1, 'John', 'Doe','jhon.doe@bolsadeideas.com');
